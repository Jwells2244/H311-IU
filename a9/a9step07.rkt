...
;Defining the program counter, which to my knowledge works kinda like the program counter in assembly, where it just tracks where you currently are in the program
;Setting the pc to apply-k for example makes the pc be set to apply-k, executing the function.
...
;Everything is a define-label now too.
