...
;Transforming all of the continuation constructors, which means we can get rid of all of the seperate functions we used.
(define-union kt
...
;Getting rid of the now redundant functions.
;(define make-closure
;  (λ (x env)
;    `(make-closure ,x ,env)))
