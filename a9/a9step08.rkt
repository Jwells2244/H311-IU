...
;Trampolining step where we add in calls to mount trampoline, and add in checks for jumpout in the empty-k define union kt. Allows us to successfully get a result
;when one is found, because it dismounts the trampoline when jumpout is found.
...
;printing the final value in register *v*
(main)